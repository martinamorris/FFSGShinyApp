...
knitr::read_chunk("../R/choroplethmapfunc.R")
knitr::read_chunk("../R/interactivemap.R")
```
...
```{r fourth, echo= FALSE, message=FALSE}
<<choromap>>
...
```{r echo = FALSE}
sliderInput("yearcart", "Year", 2000, 2017, value = 2010, animate = animationOptions(1500, TRUE),  sep = "")
```
